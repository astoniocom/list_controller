...
class MockOffsetPaginationController extends Mock
    with
        ListCore<int>,
        RecordsLoader<int, int?, List<int>?>,
        OffsetPagination<int, int?, List<int>?, int> {
  MockOffsetPaginationController() {
  ...
  @override
  int buildOffsetQuery(int offset) {
    return super.noSuchMethod(
      Invocation.method(#buildOffsetQuery, [offset], {}),
      returnValue: offset,
      returnValueForMissingStub: offset,
    ) as int;
  }

  @override
  String offsetToLoadingKey(int offset) {
    return super.noSuchMethod(
      Invocation.method(#offsetToLoadingKey, [offset], {}),
      returnValue: 'page$offset',
      returnValueForMissingStub: 'page$offset',
    ) as String;
  }
}
